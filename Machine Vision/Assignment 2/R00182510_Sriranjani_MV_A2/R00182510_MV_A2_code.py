...
def main():
    ...
    fig = plt.figure()
    ax = Axes3D(fig)
    ax.scatter3D(all_frame1_points[:, 0], all_frame1_points[:, 1], all_frame1_points[:, 2], c='g', marker='o')
    ax.scatter3D(all_frame2_points[:, 0], all_frame2_points[:, 1], all_frame2_points[:, 2], c='r', marker='^')
